    ...
    <div className='flex flex-col items-center mx-4 mb-8 justify-center w-full'>
      ...
      <div className='w-full max-w-3xl'>
        ...
        <form className='flex flex-col'>
          ...
          <input className='mb-4 p-2 border border-gray-300 rounded' type='text' id='name' name='name' />
          <label className='mb-2' htmlFor='email'>Email</label>
          <input className='mb-4 p-2 border border-gray-300 rounded' type='email' id='email' name='email' />
          <label className='mb-2' htmlFor='message'>Message</label>
          <textarea className='mb-4 p-2 border border-gray-300 rounded' id='message' name='message' rows='5'></textarea>
